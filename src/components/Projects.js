        ...
        <div className="projects" id="projects">
            ...
            <div className="projectBox">
                <div className="proj" id="1">
                    <img
                        className="pImage"
                        src="image/gitlet flow.png"
                        alt=""
                    />
                    <div className="pDetail">
                        <p className="ptitle">Gitlet</p>
                        <p className="description">
                            A version-control system mimics some of the basic
                            features of the popular system Git.
                        </p>
                        <a
                            className="pgit"
                ...
                <div className="proj" id="3">
                    ...
                    <div className="pDetail">
                        ...
                        <p className="description">
                            A website illustrates sorting algorithms animations
                            on images.
                        </p>
                        <div className="logo">
                            <a
                ...
                <div className="proj" id="4">
                    <img
                        className="pImage"
                        src="image/Pronunciation.png"
                        alt=""
                    />
                    <div className="pDetail">
                        <p className="ptitle">Pronunciation Practice</p>
                        <p className="description">
                            A speech recognition application for kids to learn
                            languages bhy practicing pronunciation.
                        </p>
                        <div className="logo">
                            <a
                                className="pgit"
                ...
                <div className="proj" id="5">
                    ...
                    <div className="pDetail">
                        ...
                        <p className="description">
                            An adversarial robust classifier based on
                            low-resolution specific neural network architecture.
                        </p>
                        <div className="logo">
                            <a
                                className="pgit"
