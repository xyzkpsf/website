    ...
    return (
        <div className="contact" id="contact">
            ...
            <div className="contactText">
                ...
                ideas, opportunities, or just want to say hello, please don't
                hesitate to send me an email. I will get back to you as soon as
                possible!
            </div>
            <div className="linkContainter">
                ...
                <div className="linkBtn">
                    <a
                        href="https://drive.google.com/file/d/1_b3-doGlODZddJ0LtidkjxXYek6dnNP5/view?usp=sharing"
                        target="_blank"
                    >
